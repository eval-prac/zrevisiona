...
describe('JobHistory e2e test', () => {
  ...
  describe('new JobHistory page', () => {
    ...
    it('should create an instance of JobHistory', () => {
      cy.get(`[data-cy="startDate"]`).type('2023-06-12T10:33').blur().should('have.value', '2023-06-12T10:33');

      cy.get(`[data-cy="endDate"]`).type('2023-06-11T17:30').blur().should('have.value', '2023-06-11T17:30');
